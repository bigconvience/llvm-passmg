# llvm-passmg
A collection of llvm passmanager examples. You can run the pass by input ./build.sh in every pass folder. All the passes are tested without buiding llvm source code.
